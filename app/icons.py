...
ICONS = {
    ...
    "sparkles": '<path d="M12 3l1.8 4.9L18.7 9l-4.9 1.8L12 15.7l-1.8-4.9L5.3 9l4.9-1.8L12 3z"/>'
                '<path d="M19 14l.9 2.4L22.3 17l-2.4.9L19 20.3l-.9-2.4-2.4-.9 2.4-.9L19 14z"/>',
    "send": '<path d="M4 4l16 8-16 8 4-8-4-8z"/><line x1="8" y1="12" x2="20" y2="12"/>',
}
